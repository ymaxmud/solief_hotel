...
export function GallerySection({ t, locale }: { t: Dictionary; locale: Locale }) {
  return (
    <section id="gallery" className="scroll-mt-40 bg-navy px-4 py-24 text-white">
      <div className="mx-auto max-w-7xl">
        <div className="relative mx-auto mb-12 max-w-3xl text-center">
          ...
          <p className="relative mb-3 text-xs font-bold uppercase tracking-[0.24em] text-champagne">{t.actions.viewPhotos}</p>
