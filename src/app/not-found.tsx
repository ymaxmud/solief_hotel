...
export default function NotFound() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center gap-6 px-6 py-24 text-center">
      <p className="font-display text-7xl font-bold text-coralBase sm:text-8xl">404</p>
      <h1 className="font-display text-2xl font-semibold text-treeGreen sm:text-3xl">This page could not be found</h1>
